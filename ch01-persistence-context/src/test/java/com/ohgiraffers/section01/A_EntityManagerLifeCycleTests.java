...
public class A_EntityManagerLifeCycleTests {
    ...
    @AfterAll  // 테스트 클래스 진행된 후 한 번만 실행되는 메소드 정의
    ...
    @DisplayName("엔티티 매니저 팩토리와 엔티티 매니저 life cycle 확인1")
    @Test
    public void lifeCycle1(){
        System.out.println("entityManagerFactory.hashCode() = " + entityManagerFactory.hashCode()); // 1916139819
        System.out.println("entityManager.hashCode() = " + entityManager.hashCode());   // 972404515
    }

    @DisplayName("엔티티 매니저 팩토리와 엔티티 매니저 life cycle 확인2")
    @Test
    public void lifeCycle2(){
        System.out.println("entityManagerFactory.hashCode() = " + entityManagerFactory.hashCode()); // 1916139819
        System.out.println("entityManager.hashCode() = " + entityManager.hashCode());   // 1504912697
    }
}
